...
@section('content')
    ...
    <div class="w3-container">
        ...
        <p class="single-text-center text-center">Cardea has more to offer!</p>
        <div class="container">
          <div class="row justify-content-center">
              <div class="col-md-12">
            <div id="carouselExampleCaptions" class="carousel slide z-index-2" data-ride="carousel" style="margin: auto">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block" style="background-color: rgba(7, 7, 7, 0.8)">
                      <h5>Dashboard</h5>
        ...
        <div class="w3-row verticle-align-center w3-center z-index-2" style="margin: 32px">
